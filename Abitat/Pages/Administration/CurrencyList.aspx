<%@ Page Title="Currencys" Language="vb" MasterPageFile="~/Site.Master"
    AutoEventWireup="false" CodeBehind="CurrencyList.aspx.vb"
    Inherits="Abitat.Pages.Administration.CurrencyList" %>
...
<asp:Content ID="ctMain" ContentPlaceHolderID="phMain" runat="server">
        ...
        <div class="card-body">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-4 text-end">
                    ...
                    <asp:Button ID="btnNew" runat="server" Text="+ New Currency"
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <i class="bi bi-key me-2"></i>Currencys
        </div>
        <div class="table-responsive">
            <asp:GridView ID="gvCurrencys" runat="server"
                AutoGenerateColumns="false"
                DataKeyNames="Id"
                CssClass="table table-hover table-sm mb-0 align-middle"
                GridLines="None"
                OnRowCommand="gvCurrencys_RowCommand"
                OnRowDataBound="gvCurrencys_RowDataBound"
                EmptyDataText="No currencys found."
                    ...
                    <asp:TemplateField HeaderText="Actions" ItemStyle-Width="230px"
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="btnToggle" runat="server"
                                ...
                                CommandArgument='<%# Eval("Id") %>'
                                CausesValidation="false"
                                OnClientClick="return confirm('Change the status of this currency?');" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
