...
Namespace Pages.Administration
    ...
    Public Class AgreementStatusEdit
        ...
        Private Const LIST_URL As String = "~/Pages/Administration/AgreementStatusList.aspx"

        'Protected Overrides ReadOnly Property RequiredPermission As String
        '    Get
        '        Return "AGREEMENTS_STATUSES_MANAGE"
        '    End Get
        'End Property
        ...
        Private Sub InitializeForm()
            ...
            Dim agr As AgreementsStatuses = _agreementStatusService.GetById(id)
            If agr Is Nothing Then
                Response.Redirect(LIST_URL, False)
                Return
            End If

            SetPageTitle("Edit agreements statuses")
            hfId.Value = agr.Id.ToString()
            txtName.Text = agr.Name
            SelectStatusById(agr.GeneralStatusId)
        End Sub
        ...
        Protected Sub btnSave_Click(sender As Object, e As EventArgs)
            ...
            Try
                Dim agr As New AgreementsStatuses With {
                    .Name = txtName.Text,
                ...
                If isEdit Then
                    agr.Id = CInt(hfId.Value)
                    _agreementStatusService.Update(agr)
                Else
                    _agreementStatusService.Insert(agr)
                End If
