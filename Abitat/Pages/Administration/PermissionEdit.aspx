<%@ Page Title="Permission" Language="vb" MasterPageFile="~/Site.Master"
         AutoEventWireup="false" CodeBehind="PermissionEdit.aspx.vb"
         Inherits="Abitat.Pages.Administration.PermissionEdit" %>
...
<asp:Content ID="ctTitle" ContentPlaceHolderID="phPageTitle" runat="server">
    <asp:Literal ID="litPageTitle" runat="server" Text="New Permission" />
</asp:Content>
...
<asp:Content ID="ctMain" ContentPlaceHolderID="phMain" runat="server">
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            ...
            <asp:Literal ID="litCardTitle" runat="server" Text="New Permission" />
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        <label for="<%= txtCode.ClientID %>" class="form-label">
                        ...
                        <asp:RequiredFieldValidator runat="server"
                            ...
                            ValidationGroup="PermissionForm"
                            CssClass="text-danger small"
                            Display="Dynamic" />
                        <asp:RegularExpressionValidator runat="server"
                            ControlToValidate="txtCode"
                            ValidationExpression="^[A-Z0-9_]+$"
                            ErrorMessage="Only uppercase letters, numbers, and underscores."
                            ValidationGroup="PermissionForm"
                            CssClass="text-danger small"
                            Display="Dynamic" />
                    </div>
        ...
        <div class="card-footer d-flex justify-content-end gap-2">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary"
                        OnClick="btnSave_Click" ValidationGroup="PermissionForm" />
        </div>
    </div>
