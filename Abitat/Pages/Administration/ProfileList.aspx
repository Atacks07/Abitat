<%@ Page Title="Permissions" Language="vb" MasterPageFile="~/Site.Master"
    AutoEventWireup="false" CodeBehind="ProfileList.aspx.vb"
    Inherits="Abitat.Pages.Administration.ProfileList" %>
...
<asp:Content ID="ctMain" ContentPlaceHolderID="phMain" runat="server">
        ...
        <div class="card-body">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-4 text-end">
                    ...
                    <asp:Button ID="btnNew" runat="server" Text="+ New Profile"
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <i class="bi bi-key me-2"></i>Profiles
        </div>
        <div class="table-responsive">
            <asp:GridView ID="gvProfiles" runat="server"
                ...
                OnRowDataBound="gvProfiles_RowDataBound"
                EmptyDataText="No profiles found."
