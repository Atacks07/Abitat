...
Namespace Pages.Administration
    ...
    Partial Public Class AgreementStatusList
        ...
        '''<summary>
        '''Control gvAgreementsStatuses.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents gvAgreementsStatuses As Global.System.Web.UI.WebControls.GridView
    End Class
End Namespace
